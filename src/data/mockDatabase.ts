...
export const INITIAL_USERS: User[] = [
  {
    ...
    email: 'rajesh.sharma@jalrakshak.org',
    role: 'admin',
    avatar: 'RS'
  },
  {
  ...
  },
  {
    id: 'usr-3',
    name: 'Marcus Chen',
    email: 'm.chen@sustainability.org',
  ...
  },
  {
    id: 'usr-4',
    name: 'Vikram Singh',
    email: 'vikram.tech@jalrakshak.org',
    role: 'maintenance',
    avatar: 'VS'
  },
  {
    id: 'usr-5',
    name: 'Elena Rostova',
    email: 'elena.guest@jalrakshak.org',
    role: 'viewer',
    avatar: 'ER'
  }
];
...
export const INITIAL_SENSORS: Sensor[] = [
  ...
  },
  {
    ...
    qualityIssues: ['14 missing readings in last 24h', '2 abnormal telemetry spikes']
  }
];
